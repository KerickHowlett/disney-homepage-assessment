import type { Content } from '@disney/home/data-access';
import { HomeStore } from '@disney/home/data-access';
import { changeDetectedBetween, Component, isNull, isUndefined, toNumber } from '@disney/shared';
...
export class ContentTileComponent extends HTMLElement {
    ...
    get imageElement(): HTMLImageElement {
        return this.element.querySelector<HTMLImageElement>('img')!;
    }
